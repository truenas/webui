...
export const domainIdmapTypeOptions: Option<IdmapBackend>[] = [
  { label: T('AD (RFC2307/SFU attributes from Active Directory)'), value: IdmapBackend.Ad },
  { label: T('LDAP'), value: IdmapBackend.Ldap },
  { label: T('RFC2307 (RFC2307 attributes from a standalone LDAP server)'), value: IdmapBackend.Rfc2307 },
  { label: T('RID (Default - algorithmic mapping based on RID values)'), value: IdmapBackend.Rid },
];
