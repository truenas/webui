...
export class PremiumFeatureWrapperComponent {
  ...
  /**
   * `ix-tooltip` renders the help each field carries. It stays operable inside the locked region:
   * the point of leaving a denied feature on screen is that an administrator can read what it
   * does, and its popper opens on a click of that icon.
   */
  protected readonly keepFocusable = 'ix-tooltip';
}
