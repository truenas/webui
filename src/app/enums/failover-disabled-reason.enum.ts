...
export const failoverDisabledReasonLabels = new Map<FailoverDisabledReason, string>([
  ...
  [FailoverDisabledReason.NoSystemReady, T('Other HarborOS controller has not finished booting.')],
  [FailoverDisabledReason.NoPong, T('Other HarborOS controller cannot be reached.')],
  [FailoverDisabledReason.NoFailover, T('Failover is administratively disabled.')],
  [FailoverDisabledReason.NoLicense, T('Other HarborOS controller has no license.')],
  [FailoverDisabledReason.DisagreeVip, T('Nodes Virtual IP states do not agree.')],
  [FailoverDisabledReason.MismatchDisks, T('The HarborOS controllers do not have the same quantity of disks.')],
  [FailoverDisabledReason.MismatchVersions, T('HarborOS software versions do not match between storage controllers.')],
