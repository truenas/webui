...
export enum Role {
  ...
  SharingS3Read = 'SHARING_S3_READ',
  SharingS3Write = 'SHARING_S3_WRITE',
  ...
  LxcConfigRead = 'LXC_CONFIG_READ',
  LxcConfigWrite = 'LXC_CONFIG_WRITE',
...
export const roleNames = new Map<Role, string>([
  ...
  [Role.SharingS3Read, T('Sharing S3 Read')],
  [Role.SharingS3Write, T('Sharing S3 Write')],
  ...
  [Role.LxcConfigRead, T('LXC Config Read')],
  [Role.LxcConfigWrite, T('LXC Config Write')],
