...
export const smbEncryptionLabels = new Map<SmbEncryption, string>([
  ...
  [SmbEncryption.Required, T('Required – always encrypt transport (rejecting access if client does not support encryption – incompatible with minimum protocol set to SMB1)')],
]);
