...
export default {
 ...
 initiators default to the initiator name as the user."),
    ...
    auth_network_tooltip: T("Network addresses that can use this \
 initiator. List network addresses with a CIDR mask. Separate multiple \
 addresses with a space: <i>192.168.2.0/24 192.168.2.1/12</i>. To allow \
 all network addresses, leave this field empty."),
}
