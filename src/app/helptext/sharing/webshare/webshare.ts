...
export const helptextSharingWebshare = {
  ...
  webshare_is_home_base_label: T('Home Directory Share'),
  webshare_is_home_base_tooltip: T('Make this share a home directory base for creating dynamic user home directories. Only one home directory share can exist per WebShare configuration.'),
  ...
  validation_errors: {
    ...
    home_base_already_exists: T('A home directory share already exists: "{name}". Only one home directory share is allowed.'),
  },
