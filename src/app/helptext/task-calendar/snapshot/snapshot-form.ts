...
export default {
 ...
 datasets except <i>child1</i>.'),
    ...
    lifetime_unit_tooltip: T('Define a length of time to retain the \
 snapshot on this system. After the time expires, the snapshot is \
 removed. Snapshots which have been replicated to other systems are not \
 affected.'),
