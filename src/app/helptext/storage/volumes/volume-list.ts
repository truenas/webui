...
export default {
    ...
    unlockDialog_services_tooltip: T('List of system services to restart when the pool is\
                      unlocked.'),
    ...
    detachDialog_pool_detach_warning_paratext_a: T("WARNING: Detaching '"),
    ...
    detachDialog_pool_detach_confim_checkbox_placeholder: T("Confirm detach"),
