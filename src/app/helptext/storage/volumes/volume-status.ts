...
export default {
 ...
 on the unused disk will be erased!'),
  ...
  exported_zpool_warning: T('This disk is part of the exported zpool {zpool}. Adding this disk to a new or existing pool will make {zpool} unable to import. You will lose any and all data in {zpool}. Please make sure you have backed up any sensitive data in {zpool} before reusing/repurposing this disk.'),
