...
manager_duplicate_title: T("Duplicate Data VDev"),
manager_duplicate_vdevs_tooltip: T("Select the number of VDevs to create using the first data VDev as a template."),
manager_duplicate_vdevs_placeholder: T("Number of VDevs"),
manager_duplicate_button: T("Duplicate")
