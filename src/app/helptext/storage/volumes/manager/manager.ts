...
export default {
 ...
 be sized to <i>X</i> GiB for each <i>X</i> TiB of general storage.'),
  exported_zpool_warning: T('This disk is part of the exported pool {zpool}. Adding this disk to a new or other existing pools will make {zpool} unable to import. You will lose any and all data in {zpool}. Please make sure you have backed up any sensitive data in {zpool} before reusing/repurposing this disk.'),
