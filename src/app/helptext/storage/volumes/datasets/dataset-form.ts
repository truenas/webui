...
export default {
 ...
 written and read. When the ACL type is changed from POSIX to NFSv4, \
 no migration is performed for default and access ACLs encoded in the \
 posix1e acl extended attributes to native ZFS ACLs. When ACL type is \
 ...
 by ZFS for access checks. This means that the user must manually set \
 new ACLs recursively on the dataset after ACL type changes in order to \
 avoid unexpected permissions behavior. This action will be destructive, \
