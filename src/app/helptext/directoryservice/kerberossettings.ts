...
<a href="https://www.freebsd.org/cgi/man.cgi?query=krb5.conf&apropos=0&sektion=5&manpath=FreeBSD+11.3-RELEASE&arch=default&format=html" target="_blank">[krb.conf(5)]</a>.\
