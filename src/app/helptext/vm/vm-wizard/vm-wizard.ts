...
This will improve CPU cache locality and can reduce possible stutter in GPU passthrough VMs.'),
 ...
 timeout has expired.'),
  ...
  global_tooltip: helptextGlobal.humanReadable.suggestionTooltip,
 ...
 the VM.'),
  ...
  upload_iso_pool_root_error: T('Cannot upload to /mnt or pool root. Please select a dataset under the pool (e.g., /mnt/pool/dataset).'),
};
