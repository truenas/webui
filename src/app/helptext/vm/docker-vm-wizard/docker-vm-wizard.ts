...
docker_vm_label: 'Docker Host Details',
docker_vm_placeholder :  T ('Name'),
docker_vm_tooltip : T('Enter a name for this Docker Host.'),
...
memory_tooltip: T('Allocate a number of megabytes of RAM to the Docker Host.'),
memory_value: 2048,
