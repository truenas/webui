...
export default {
    ...
    timeout_tooltip: T('Maximum client idle time in seconds before client is\
                    disconnected.'),
    ...
    tls_opt_allow_per_user_tooltip: T('If set, the password of the user can be sent\
                unencrypted.'),
    ...
    tls_opt_export_cert_data_tooltip: T('Set to export the certificate environment\
                variables.'),
