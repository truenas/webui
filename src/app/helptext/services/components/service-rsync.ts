...
rsyncmod_name_tooltip: 'Module name that matches the name requested by \
 the rsync client.',
...
rsyncmod_path_tooltip: 'Browse to the pool or dataset to store received \
 data.',
...
rsyncmod_maxconn_tooltip: 'Maximum connections to this module. <i>0</i> \
 is unlimited.',

rsyncmod_user_placeholder: 'User',
rsyncmod_user_tooltip: 'User to run as during file transfers to and from \
 this module.',

rsyncmod_group_placeholder: 'Group',
rsyncmod_group_tooltip: 'Group to run as during file transfers to and \
 from this module.',
