...
export default {
    ...
    rsyncmod_name_tooltip: 'This <b>must</b> match the settings on the rsync\
                  client.',
    ...
    rsyncmod_user_tooltip: 'Select the user to conduct file transfers to and from\
                  this module.',

    rsyncmod_group_placeholder: 'Group',
    rsyncmod_group_tooltip: 'Select the group to conduct file transfers to and from\
                  this module.',
