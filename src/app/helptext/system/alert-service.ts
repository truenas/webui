...
export const helptextAlertService = {
 ...
 service.'),
  ...
  level_tooltip: T('Select the level of severity. Alert notifications send for all warnings \
 matching and above the selected level. For example, a warning level set to Critical \
 triggers notifications for Critical, Alert, and Emergency level warnings.'),
