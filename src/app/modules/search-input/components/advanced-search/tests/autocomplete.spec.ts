...
} from 'app/modules/search-input/services/advanced-search-autocomplete.service';
...
import { dateProperty, searchProperties, textProperty } from 'app/modules/search-input/utils/search-properties.utils';
