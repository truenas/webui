...
export class EntityUtils {
  ...
  handleWsError(
    ...
    if ('exc_info' in errorOrJob && errorOrJob.exc_info && errorOrJob.exc_info.extra) {
      (errorOrJob as any).extra = errorOrJob.exc_info.extra;
    }

    if ('extra' in errorOrJob && errorOrJob.extra && (targetFieldConfig || entity.fieldConfig || entity.wizardConfig)) {
      let scroll = false;
      if ((errorOrJob.extra as any).excerpt) {
