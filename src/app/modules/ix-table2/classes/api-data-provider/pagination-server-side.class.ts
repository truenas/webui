import { ApiCallParamsRecord } from 'app/modules/ix-table2/classes/api-data-provider/api-data-provider';
import { TablePagination } from 'app/modules/ix-table2/interfaces/table-pagination.interface';

export class PaginationServerSide {
  getParams(pagination: TablePagination, totalRows: number): ApiCallParamsRecord {
