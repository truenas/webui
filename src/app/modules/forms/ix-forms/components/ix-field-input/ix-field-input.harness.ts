...
export interface IxFieldInputHarnessFilters extends BaseHarnessFilters {
  label?: string;
}

export class IxFieldInputHarness extends ComponentHarness implements IxFormControlHarness {
  static readonly hostSelector = 'ix-field-input';

  static with(options: IxFieldInputHarnessFilters): HarnessPredicate<IxFieldInputHarness> {
    return new HarnessPredicate(IxFieldInputHarness, options)
