import {
  computed, effect, inject, isDevMode, isSignal, signal, Signal,
} from '@angular/core';
 ...
 *
 * The tail of the file holds workarounds for behaviour `tn-table` does not expose yet. Each is
 * marked `TEMP (NAS-141021)` and is meant to be deleted the moment `@truenas/ui-components` grows
