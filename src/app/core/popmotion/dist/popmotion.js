(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var keyframes = function (_a) {
        ...
        var scrubbers = easings.map(function (easing, i) { return vectorScrubber({
            from: values[i],
            to: values[i + 1],
            ease: easing
        }); });
    ...
    ***************************************************************************** */
    ...
    var contains$1 = function (term) { return function (v) {
        return typeof v === 'string' && v.indexOf(term) !== -1;
    }; };
    var isFirstChars$1 = function (term) { return function (v) {
        return typeof v === 'string' && v.indexOf(term) === 0;
    }; };
    var getValueFromFunctionString$1 = function (value) {
        return value.substring(value.indexOf('(') + 1, value.lastIndexOf(')'));
    };
    var splitCommaDelimited$1 = function (value) {
        return typeof value === 'string' ? value.split(/,\s*/) : [value];
    };
    ...
    var alpha$1 = __assign$2({}, number$1, { transform: clamp$2(0, 1) });
    var scale$1 = __assign$2({}, number$1, { default: 1 });

    var createUnitType$1 = function (unit) {
        var containsUnit = contains$1(unit);
        return {
            test: function (v) {
                return typeof v === 'string' && containsUnit(v) && v.split(' ').length === 1;
            },
    ...
    var onlyColorRegex$1 = /^(#[0-9a-f]{3}|#(?:[0-9a-f]{2}){2,4}|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))$/i;
    ...
    var splitColorValues$1 = function (terms) {
        ...
        return function (v) {
            if (typeof v !== 'string')
                return v;
            var values = {};
            var valuesArray = splitCommaDelimited$1(getValueFromFunctionString$1(v));
            for (var i = 0; i < numTerms; i++) {
                values[terms[i]] =
                    valuesArray[i] !== undefined ? parseFloat(valuesArray[i]) : 1;
            }
    ...
    var rgbUnit$1 = __assign$2({}, number$1, { transform: function (v) { return Math.round(clampRgbUnit$1(v)); } });
    var testRgbaString$1 = isFirstChars$1('rgb');
    var rgba$1 = {
        test: function (v) { return (typeof v === 'string' ? testRgbaString$1(v) : isRgba$1(v)); },
    ...
    var testHslaString$1 = isFirstChars$1('hsl');
    var hsla$1 = {
        test: function (v) { return (typeof v === 'string' ? testHslaString$1(v) : isHsla$1(v)); },
        parse: splitColorValues$1(['hue', 'saturation', 'lightness', 'alpha']),
        transform: function (_a) {
            var hue = _a.hue, saturation = _a.saturation, lightness = _a.lightness, alpha$$1 = _a.alpha;
            return hslaTemplate$1({
                hue: Math.round(hue),
                saturation: percent$1.transform(saturation),
                lightness: percent$1.transform(lightness),
                alpha: alpha$$1
            });
        }
    };
    var hex$1 = __assign$2({}, rgba$1, { test: isFirstChars$1('#'), parse: function (v) {
            var r = '';
            var g = '';
            var b = '';
            if (v.length > 4) {
    ...
    var color$1 = {
        test: function (v) {
            return (typeof v === 'string' && onlyColorRegex$1.test(v)) ||
                rgba$1.test(v) ||
                hsla$1.test(v) ||
                hex$1.test(v);
        },
    ...
    var valueTypes = {
        ...
        perspective: px$1,
        opacity: alpha$1,
        transformOriginX: percent$1,
        transformOriginY: percent$1,
        transformOriginZ: px$1
    };
