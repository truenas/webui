  	...
  	<div *ngIf="this.entity.conf.route_add || this.actions.length > 0">
		<smd-fab-speed-dial id="myFab" #myFab [direction]="direction" [animationMode]="animationMode"
			...
			<smd-fab-trigger [spin]="!this.entity.conf.route_add">
				<button id="add_action_button" [disabled]="this.entity.conf.add_disabled" *ngIf="this.entity.conf.route_add; else elseBlock" mat-fab (click)="this.entity.doAdd()" matTooltip="{{this.entity.conf.route_add_tooltip | translate}}">
