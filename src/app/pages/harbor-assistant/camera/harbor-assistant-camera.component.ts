...
export class HarborAssistantCameraComponent implements OnInit {
  ...
  selectedSnapshotUrl(): string | null {
    ...
    return this.withRefreshToken(`/api/harbor-assistant/cameras/${encodeURIComponent(deviceId)}/snapshot.jpg`);
  }
