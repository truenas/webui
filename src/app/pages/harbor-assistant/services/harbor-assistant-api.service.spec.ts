...
describe('Harbor Assistant API service', () => {
  ...
  it('uses the same-origin Harbor Assistant state endpoint', async () => {
    ...
    const req = httpMock.expectOne('/api/beacon/state');
  ...
  it('keeps device management actions under /api/beacon', async () => {
    const deviceId = 'cam 1/left';

    const rtspPromise = firstValueFrom(spectator.service.checkDeviceRtsp(deviceId, { reason: 'test' }));
    const rtspReq = httpMock.expectOne('/api/beacon/devices/cam%201%2Fleft/rtsp-check');
    ...
    const evidenceReq = httpMock.expectOne('/api/beacon/devices/cam%201%2Fleft/evidence');
    ...
    const shareReq = httpMock.expectOne('/api/beacon/cameras/cam%201%2Fleft/share-link');
    expect(shareReq.request.method).toBe('POST');
    shareReq.flush({});
    await sharePromise;
  });

  it('keeps camera DVR management APIs under /api/beacon', async () => {
    const settings = {
    ...
    const settingsReq = httpMock.expectOne('/api/beacon/cameras/recording-settings');
    ...
    const saveReq = httpMock.expectOne('/api/beacon/cameras/recording-settings');
    ...
    const statusReq = httpMock.expectOne('/api/beacon/cameras/recordings/status');
    ...
    const timelineReq = httpMock.expectOne('/api/beacon/cameras/recordings/timeline?device_id=camera-main');
    ...
    const startReq = httpMock.expectOne('/api/beacon/cameras/camera-main/recordings/start');
    ...
    const stopReq = httpMock.expectOne('/api/beacon/cameras/camera-main/recordings/stop');
  ...
  it('keeps local vision event observability read-only under /api/beacon', async () => {
    const eventsPromise = firstValueFrom(spectator.service.getLocalVisionEvents(3));
    const eventsReq = httpMock.expectOne('/api/beacon/vision/events?limit=3');
  ...
  it('does not send credential reads or secrets to HarborGate paths', async () => {
    ...
    const req = httpMock.expectOne('/api/beacon/devices/cam-1/credentials');
  ...
  it('keeps settings status APIs under /api/beacon', async () => {
    const gatewayPromise = firstValueFrom(spectator.service.getGatewayStatus());
    const gatewayReq = httpMock.expectOne('/api/beacon/gateway/status');
    ...
    const inferenceReq = httpMock.expectOne('/api/beacon/inference/healthz');
    ...
    const targetsReq = httpMock.expectOne('/api/beacon/admin/notification-targets');
    ...
    const defaultReq = httpMock.expectOne('/api/beacon/admin/notification-targets/default');
    ...
    const deleteReq = httpMock.expectOne('/api/beacon/admin/notification-targets/route%2Fweixin');
    expect(deleteReq.request.method).toBe('DELETE');
    deleteReq.flush({});
    await deletePromise;

    const hardwarePromise = firstValueFrom(spectator.service.getHardwareReadiness());
    const hardwareReq = httpMock.expectOne('/api/beacon/hardware/readiness');
    ...
    const harborOsReq = httpMock.expectOne('/api/beacon/harboros/im-capability-map');
  ...
  it('keeps Home Assistant APIs under the Harbor Assistant proxy', async () => {
    ...
    const statusReq = httpMock.expectOne('/api/beacon/home-assistant/status');
    expect(statusReq.request.method).toBe('GET');
    ...
    const configReq = httpMock.expectOne('/api/beacon/home-assistant/config');
    ...
    const testReq = httpMock.expectOne('/api/beacon/home-assistant/test');
    ...
    const syncReq = httpMock.expectOne('/api/beacon/home-assistant/sync');
    ...
    const entitiesReq = httpMock.expectOne('/api/beacon/home-assistant/entities');
    ...
    const servicesReq = httpMock.expectOne('/api/beacon/home-assistant/services');
    ...
    const installStatusReq = httpMock.expectOne('/api/beacon/harboros/apps/home-assistant/status');
    ...
    const installPlanReq = httpMock.expectOne('/api/beacon/harboros/apps/home-assistant/install-plan');
    ...
    const installReq = httpMock.expectOne('/api/beacon/harboros/apps/home-assistant/install');
  ...
  it('keeps automation review APIs under /api/beacon', async () => {
    const response = {
      generated_at: '1',
      pending_count: 1,
      reviews: [{
    ...
    const listReq = httpMock.expectOne('/api/beacon/automation/reviews');
    ...
    const createReq = httpMock.expectOne('/api/beacon/automation/reviews');
    ...
    const enableReq = httpMock.expectOne('/api/beacon/automation/reviews/review%2F1/enable');
    ...
    const pauseReq = httpMock.expectOne('/api/beacon/automation/reviews/review%2F1/pause');
    ...
    const discardReq = httpMock.expectOne('/api/beacon/automation/reviews/review%2F1/discard');
  ...
  it('keeps model management APIs under /api/beacon', async () => {
    ...
    const runtimesReq = httpMock.expectOne('/api/beacon/models/runtimes');
    ...
    const runtimeInstallReq = httpMock.expectOne('/api/beacon/models/runtimes/harbor-candle/install');
    ...
    const patchReq = httpMock.expectOne('/api/beacon/models/endpoints/llm%2Flocal');
    ...
    const testReq = httpMock.expectOne('/api/beacon/models/endpoints/llm%2Flocal/test');
    expect(testReq.request.method).toBe('POST');
    ...
    const downloadReq = httpMock.expectOne('/api/beacon/models/local-downloads');
  ...
  it('keeps knowledge and file-picker APIs under /api/beacon', async () => {
    const settings = {
      source_roots: [{
        root_id: 'mm-test',
        label: 'MM test',
    ...
    const settingsReq = httpMock.expectOne('/api/beacon/knowledge/settings');
    expect(settingsReq.request.method).toBe('GET');
    settingsReq.flush(settings);
    ...
    const saveReq = httpMock.expectOne('/api/beacon/knowledge/settings');
    expect(saveReq.request.method).toBe('PUT');
    ...
    const indexReq = httpMock.expectOne('/api/beacon/knowledge/index/run');
    ...
    const statusReq = httpMock.expectOne('/api/beacon/knowledge/index/status');
    expect(statusReq.request.method).toBe('GET');
    statusReq.flush({
      generated_at: '1',
      status: 'ready',
    ...
    const browseReq = httpMock.expectOne('/api/beacon/files/browse?path=%2Fmnt%2FMM-test');
  ...
  it('keeps defaults and metadata management in HarborBeacon AIoT paths', async () => {
    ...
    const defaultsReq = httpMock.expectOne('/api/beacon/defaults');
    ...
    const metadataReq = httpMock.expectOne('/api/beacon/devices/cam%201');
    ...
    const deleteReq = httpMock.expectOne('/api/beacon/devices/cam%201');
    expect(deleteReq.request.method).toBe('DELETE');
  ...
  it('keeps Beacon calls on the Harbor Assistant same-origin proxy', () => {
    ...
    literalApiUrls.forEach((url) => expect(url).toContain('/api/beacon'));
    expect(source).toContain('/api/beacon/inference/healthz');
