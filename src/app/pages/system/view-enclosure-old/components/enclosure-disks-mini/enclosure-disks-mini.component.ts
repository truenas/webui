...
import { Mini } from 'app/pages/system/view-enclosure-old/classes/hardware/mini';
import { MiniX } from 'app/pages/system/view-enclosure-old/classes/hardware/mini-x';
import { MiniXlPlus } from 'app/pages/system/view-enclosure-old/classes/hardware/mini-xl-plus';
import {
  EnclosureDisksComponent,
} from 'app/pages/system/view-enclosure-old/components/enclosure-disks/enclosure-disks.component';
import { EnclosureStore } from 'app/pages/system/view-enclosure-old/stores/enclosure-store.service';
