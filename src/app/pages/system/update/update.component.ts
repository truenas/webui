...
export class UpdateComponent implements OnInit {
  ...
  protected readonly manualUpdateUrl = computed(() => {
    ...
    if (sysver.includes('MASTER') || !version) {
      return 'https://harboros.ai/docs/scale/scaletutorials/systemsettings/updatescale/';
    }

    return `https://harboros.ai/docs/scale/${version[0]}/scaletutorials/systemsettings/updatescale/`;
  });
