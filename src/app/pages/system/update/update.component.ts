        ...
        (res) => {
          ...
          if (res.status === 'AVAILABLE') {
            ...
            const ds  = this.dialogService.confirm(
              "Download Update", "Continue with download?",true,"",true,"Apply updates and reboot system after downloading.","update.update",[{ train: this.train, reboot: false }], 'download-update'
            )
