...
import { ConsoleFormComponent } from './console/console-form/console-form.component';
...
import { KernelFormComponent } from './kernel/kernel-form/kernel-form.component';
import { SyslogFormComponent } from './syslog/syslog-form/syslog-form.component';
...
@UntilDestroy()
@Component({
  templateUrl: './advanced-settings.component.old.html',
    ...
    tableActions: [
      {
        ...
        onClick: () => {
          this.slideInService.open(AllowedAddressesFormComponent);
        },
      },
    ],
  };
  ...
  async onSettingsPressed(name: AdvancedCardId): Promise<void> {
    ...
    switch (name) {
      ...
      case AdvancedCardId.Storage:
        this.slideInService.open(StorageSettingsFormComponent).setFormForEdit({
          pool: this.systemDatasetPool,
          swapondrive: this.configData.swapondrive.toString(),
        });
        break;
      case AdvancedCardId.Gpus:
        this.slideInService.open(IsolatedGpusFormComponent);
        break;
      case AdvancedCardId.Sed:
        this.slideInService.open(SelfEncryptingDriveFormComponent).setupForm(this.configData, this.sedPassword);
        break;
      default:
        break;
    }
