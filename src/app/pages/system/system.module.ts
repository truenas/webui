...
import { TrainInfoCardComponent } from 'app/pages/system/update/train-info-card/train-info-card.component';
import { UpdateActionsCardComponent } from 'app/pages/system/update/update-actions-card/update-actions-card.component';
