...
import { BaseEnclosureDirective } from 'app/pages/system/enclosure/components/enclosures/base-enclosure/base-enclosure.directive';
...
export class M50EnclosureComponent extends BaseEnclosureDirective {
