import {
  ChangeDetectionStrategy, Component, OnInit, signal, inject, DestroyRef, effect,
} from '@angular/core';
...
export class WebShareSharesFormComponent implements OnInit {
  ...
  constructor() {
    // Manage form disabled state based on loading
    effect(() => {
  ...
  private setupPathAutoPopulate(): void {
    ...
    // Track the initial name value to detect if it was pre-filled
