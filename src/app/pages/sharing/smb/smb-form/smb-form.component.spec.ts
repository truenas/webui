...
describe('SmbFormComponent', () => {
  ...
  describe('creating share of each type', () => {
    ...
    it('creates FCP (Final Cut Storage Share) share', async () => {
      await submitForm({
        ...commonValues,
        Purpose: 'Final Cut Storage Share',
      });
  ...
  describe('edit FCP share', () => {
    ...
    it('disables aapl_name_mangling checkbox for FCP purpose', async () => {
      ...
      await form.fillForm({ Purpose: 'Final Cut Storage Share' });
      spectator.detectChanges();
