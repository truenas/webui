...
} from 'app/pages/storage-old/volumes/permissions/interfaces/dataset-acl-editor-state.interface';
import { newNfsAce, newPosixAce } from 'app/pages/storage-old/volumes/permissions/utils/new-ace.utils';
import {
        ...
        const conf: DialogFormConfiguration = {
          ...
          customSubmit: (entityDialog: EntityDialogComponent) => {
            ...
            dialogRef.componentInstance.success.pipe(takeUntil(this.destroy$)).subscribe(() => {
              dialogRef.close();
              this.router.navigate(['/storage-old']);
            });
