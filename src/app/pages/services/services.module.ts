...
import {RSYNCconfigurationComponent} from './components/service-rsync/rsyncconfiguration/rsyncconfiguration-form'
...
@NgModule({
  ...
  declarations : [
    ...
    ServiceRSYNCComponent, RSYNCconfigurationComponent, ServiceSMARTComponent, ServiceNFSComponent,
