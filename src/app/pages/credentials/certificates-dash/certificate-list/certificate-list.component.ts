...
export class CertificateListComponent implements OnInit {
  ...
  doDelete(certificate: Certificate): void {
    ...
    confirmation$.pipe(
      filter((forceConfirm: ConfirmForceDeleteDialogResponse) => forceConfirm.confirmed),
      switchMap((forceConfirm: ConfirmForceDeleteDialogResponse) => {
        const jobDialog$ = this.dialogService.jobDialog(
          this.ws.job('certificate.delete', [certificate.id, forceConfirm.force]),
