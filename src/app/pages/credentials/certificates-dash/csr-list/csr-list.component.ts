      ...
      actions: [
        {
          ...
          getTestAttr: (row) => 'csr-' + row.id + '-build',
        },
        {
          iconName: 'mdi-download',
          tooltip: this.translate.instant('Download'),
          onClick: (row) => this.doDownload(row),
          getTestAttr: (row) => 'csr-' + row.id + '-download',
        },
        {
          iconName: 'edit',
          tooltip: this.translate.instant('Edit'),
          onClick: (row) => this.doEdit(row),
          getTestAttr: (row) => 'csr-' + row.id + '-edit',
        },
        {
          iconName: 'delete',
          tooltip: this.translate.instant('Delete'),
          onClick: (row) => this.doDelete(row),
          getTestAttr: (row) => 'csr-' + row.id + '-delete',
        },
      ],
    }),
  ]);
