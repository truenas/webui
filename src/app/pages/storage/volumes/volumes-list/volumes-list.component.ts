          ...
          this.getPoolData(row1.id).subscribe((res) => {
            if (res[0]) {
              if (res[0].scan.function === "SCRUB" && res[0].scan.state === "SCANNING") {
                ...
                this.dialogService.confirm("Scrub Pool", message, false, "Stop Scrub").subscribe((res) => {
                  if (res) {
                    this.loader.open();
                ...
                this.dialogService.confirm("Scrub Pool", message, false, "Start Scrub").subscribe((res) => {
                  if (res) {
                    this.loader.open();
