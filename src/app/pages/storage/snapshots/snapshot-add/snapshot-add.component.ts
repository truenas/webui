...
@Component(
    {selector : 'snapshot-add', templateUrl : './snapshot-add.component.html'})
export class SnapshotAddComponent implements OnInit {
  ...
  public formModel: DynamicFormControlModel[] = [
    new DynamicInputModel({id : 'name', label : 'Snapshot Name'}),
    new DynamicCheckboxModel({id : 'recursive', label : 'Recursive'})
  ];
  ...
  ngOnInit() {
    ...
    let placeholder =
        this.formService.findById("name", this.formModel) as DynamicInputModel;
