...
import { ZfsPoolData } from 'app/pages/storage/volumes/volumes-list/volumes-list.component';
  ...
  ngOnInit(): void {
    ...
    this.rest.get("storage/volume", {}).subscribe((res) => {
      res.data.forEach((volume) => {
        volume.disksListConfig = new DisksListConfig(this.router, volume.id, volume.name);
        volume.type = 'zpool';
