...
export interface InstanceNicFormDialogData {
...
@UntilDestroy()
@Component({
  selector: 'ix-instance-nic-form-dialog',
  templateUrl: './instance-nic-form-dialog.component.html',
  standalone: true,
  imports: [
    MatDialogContent,
    MatDialogActions,
...
export class InstanceNicFormDialog {
