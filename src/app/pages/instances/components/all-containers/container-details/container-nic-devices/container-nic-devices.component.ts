...
import { AddNicMenuComponent } from 'app/pages/instances/components/all-containers/container-details/container-nic-devices/add-nic-menu/add-nic-menu.component';
import {
