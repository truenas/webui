...
import { StopOptionsDialog, StopOptionsOperation } from 'app/pages/instances/components/all-containers/container-list/stop-options-dialog/stop-options-dialog.component';
