...
import {
  VmBootloader, VmCpuMode, VmDeviceType, VmOs, VmTime, vmTimeNames,
...
export class VmWizardOldComponent implements WizardConfiguration {
  ...
  getFormControlFromFieldName(fieldName: string, parent: VmWizardOldComponent = this): UntypedFormControl {
  ...
  getFormArrayIndexFromFieldName(fieldName: string, parent: VmWizardOldComponent = this): number {
