...
describe('ChartFormComponent', () => {
  ...
  it('shows values for an existing ChartForm when form is opened', async () => {
    spectator.component.setTitle(existingChart.name);
    spectator.component.setChartConfig(existingChart.config);
    spectator.component.parseChartSchema(existingChart.chart_schema);
  ...
  it('edits existing ChartForm when form is submitted', () => {
    spectator.component.setTitle(existingChart.name);
    spectator.component.setChartConfig(existingChart.config);
    spectator.component.parseChartSchema(existingChart.chart_schema);
