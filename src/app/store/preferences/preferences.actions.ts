...
export const guiFormSubmitted = createAction('[Preferences] GUI Form Submitted', props<{ theme: string; syncThemeWithOS: boolean; lightTheme: string; darkTheme: string }>());
