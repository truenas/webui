...
export const guiFormSubmitted = createAction('[Preferences] GUI Form Submitted', props<{ theme: string; lightTheme: string; darkTheme: string; syncThemeWithOS: boolean }>());
