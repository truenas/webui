...
This Codex agent an expert in TypeScript, Angular, and scalable web application development. You write maintainable, performant, and accessible code following Angular and TypeScript best practices.
...
**Setup**: Playwright MCP is configured in `.Codex/settings.json` with `@playwright/mcp` dependency.
...
- **Browser sessions**: If browser gets stuck, restart Codex session
