...
def test_apps_page_validation(driver):
    ...
    if not is_element_present(driver, '//h1[contains(.,"Applications")]'):
        assert wait_on_element(driver, 20, '//mat-list-item[@ix-auto="option__Apps"]', 'clickable')
        driver.find_element_by_xpath('//mat-list-item[@ix-auto="option__Apps"]').click()
    assert wait_on_element(driver, 20, '//h1[contains(.,"Applications")]')
    ...
    assert wait_on_element(driver, 15, '//h1[contains(.,"Choose a pool for Apps")]')
    time.sleep(0.5)
    ...
    assert wait_on_element(driver, 15, '//span[contains(text(),"tank")]', 'clickable')
    driver.find_element_by_xpath('//span[contains(text(),"tank")]').click()
    assert wait_on_element(driver, 15, '//span[contains(text(),"Choose")]', 'clickable')
    ...
    assert wait_on_element(driver, 20, '//button[contains(text(),"Advanced Settings")]', 'clickable')
    ...
    assert wait_on_element(driver, 15, '//h3[contains(.,"No Applications Installed")]')
    # test the buttons
    assert wait_on_element(driver, 20, '//span[contains(.,"Launch Docker Image")]', 'clickable')
    ...
    assert wait_on_element(driver, 15, '//div[contains(.,"https://github.com/truenas/charts.git")]')
    # test the buttons
    assert wait_on_element(driver, 20, '//span[contains(.,"Launch Docker Image")]', 'clickable')
    driver.find_element_by_xpath('//span[contains(.,"Launch Docker Image")]').click()
    if wait_on_element(driver, 3, '//*[contains(.,"Please wait")]'):
