...
def validate_truecommand(driver):
    ...
    import t_006_7_validate_minio_with_docker
    t_006_7_validate_minio_with_docker.test_validate_minio_with_docker(driver)
...
def add_a_catalog(driver):
    """add_a_catalog"""
#    import t_006_9_add_a_catalog
#    t_006_9_add_a_catalog.test_add_a_catalog(driver)


@then('remove a catalog')
def remove_a_catalog(driver):
    """remove_a_catalog"""
#    import t_006_10_remove_a_catalog
#    t_006_10_remove_a_catalog.test_remove_a_catalog(driver)


@then('delete a docker container')
def delete_a_docker_container(driver):
    """delete_a_container"""
#    import t_006_11_delete_a_docker_container
#    t_006_11_delete_a_docker_container.test_delete_a_docker_container(driver)