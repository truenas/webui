...
def add_acl_item_on_tank(driver):
...
def add_acl_item_on_tank(driver):
    """add acl item on tank"""
#    import t_002_6_add_acl_item_on_tank
#    t_002_6_add_acl_item_on_tank.test_add_acl_item_on_tank(driver, input, user)
...
def create_smb_share_on_system(driver):
...
def create_smb_share_on_tank(driver):
