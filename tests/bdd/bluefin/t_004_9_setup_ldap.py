...
#    assert wait_on_element(driver, 10, '//h1[contains(.,"Storage Dashboard")]')
   ...
   # click on sharing and click add
    ...
    assert wait_on_element(driver, 10, '//h3[text()="Active Directory"]')
    ...
    assert wait_on_element(driver, 10, '//span[contains(text(),"Configure LDAP")]', 'clickable')

    assert wait_on_element(driver, 15, '//ix-chips//ix-label//label//span[contains(.,"Hostname")]')
    assert wait_on_element(driver, 10, '//ix-chips//ix-label//label//span[contains(.,"Hostname")]//ancestor::ix-chips//div//mat-chip-list//div//input', 'inputable')
    ...
    assert wait_on_element(driver, 15, '//span[contains(text(),"Base DN")]')
    assert wait_on_element(driver, 10, '//ix-fieldset//fieldset//ix-input//ix-label//label//span[contains(text(),"Base DN")]//ancestor::ix-input//div//input', 'inputable')
    ...
    assert wait_on_element(driver, 15, '//span[contains(text(),"Bind DN")]')
    assert wait_on_element(driver, 10, '//ix-fieldset//fieldset//ix-input//ix-label//label//span[contains(text(),"Bind DN")]//ancestor::ix-input//div//input', 'inputable')
    ...
    assert wait_on_element(driver, 15, '//span[contains(text(),"Bind Password")]')
    assert wait_on_element(driver, 10, '//ix-fieldset//fieldset//ix-input//ix-label//label//span[contains(text(),"Bind Password")]//ancestor::ix-input//div//input', 'inputable')
    ...
    #time.sleep(2)
    #assert wait_on_element(driver, 10, '//ix-fieldset//fieldset//ix-checkbox/mat-checkbox[1]/label[1]//following-sibling::span[contains(.,"Samba")]', 'clickable')
    ...
    assert wait_on_element(driver, 15, '//span[contains(text(),"OFF")]', 'clickable')
    driver.find_element_by_xpath('//span[contains(text(),"OFF")]').click()
    assert wait_on_element(driver, 15, '//mat-option[2]//span[contains(text(),"ON")]', 'clickable')
    time.sleep(0.5)
