...
@scenario('features/NAS-T1066.feature', 'Enable user Permit Sudo')
...
def click_on_the_credentials_on_the_side_menu_click_on_local_users():
...
@then('Then the User Edit Page should open, click Enable Permit Sudo checkbox and click save')
def the_user_edit_page_should_open():
    """the User Edit Page should open,  click Enable Permit Sudo checkbox and click save."""
...
def the_changes_should_be_saved():
...
@then('And open the user dropdown')
def the_users_page_should_open():
    """And open the user dropdown."""
    assert wait_on_element(driver, 1, 7, '//div[contains(.,"Users")]', 'clickable')
    driver.find_element_by_xpath('//a[@ix-auto="expander__ericbsd"]').click()
    assert wait_on_element(driver, 0.5, 7, '//button[@ix-auto="button__EDIT_ericbsd"]', 'clickable')
    driver.find_element_by_xpath('//button[@ix-auto="button__EDIT_ericbsd"]').click()
