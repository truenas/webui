...
def you_are_on_the_dashboard_click_on_datasets_in_the_side_menu(driver):
    ...
    assert wait_on_element(driver, 5, xpaths.dashboard.systemInfoCardTitle)
...
def on_the_datasets_page_create_a_smb_dataset_rtacltest1_with_tank(driver, dataset1_name):
    ...
    driver.find_element_by_xpath(xpaths.addDataset.name_textarea).send_keys(dataset1_name)
...
def create_a_second_smb_dataset_rtacltest2_under_rtacltest1(driver, dataset2_name, dataset1_name):
    ...
    assert wait_on_element(driver, 5, xpaths.addDataset.title)
    assert wait_on_element(driver, 5, xpaths.addDataset.name_textarea, 'inputable')
    driver.find_element_by_xpath(xpaths.addDataset.name_textarea).send_keys(dataset2_name)
    assert wait_on_element(driver, 5, xpaths.addDataset.select_share_type)
    driver.find_element_by_xpath(xpaths.addDataset.select_share_type).click()
    assert wait_on_element(driver, 5, xpaths.addDataset.shareTypeSMB_option, 'clickable')
    driver.find_element_by_xpath(xpaths.addDataset.shareTypeSMB_option).click()
...
def create_a_third_smb_dataset_rtacltest3(driver, dataset3_name, dataset1_name):
    ...
    driver.find_element_by_xpath(xpaths.addDataset.name_textarea).send_keys(dataset3_name)
    assert wait_on_element(driver, 5, xpaths.addDataset.select_share_type)
    driver.find_element_by_xpath(xpaths.addDataset.select_share_type).click()
    assert wait_on_element(driver, 5, xpaths.addDataset.shareTypeSMB_option, 'clickable')
    driver.find_element_by_xpath(xpaths.addDataset.shareTypeSMB_option).click()
