# coding=utf-8
"""SCALE UI: Create an smb share with the tank ACL dataset feature tests."""
...
def mytankshare_should_be_added_click_on_service_and_the_service_page_should_open(driver, smbname):
...
def send_a_file_to_the_share_with_nas_ipmytankshare_and_administrator_and_abcd1234(driver, nas_ip, my_acl_dataset, user, password):
