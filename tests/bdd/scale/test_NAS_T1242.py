...
def the_pools_page_appears_click_create_pool():
...
def the_pool_manager_appears_enter_encrypted_tank_for_pool_name():
...
def click_encryption_and_confirm_popup():
...
def click_a_drive_checkbox_and_press_the_right_arrow():
...
def click_create_confirm_the_warning_checkbox_and_click_create_pool():
...
def the_pool_should_be_listed_on_the_storage_page():
