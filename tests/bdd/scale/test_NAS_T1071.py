...
def click_sdb_checkbox_press_the_right_arrow_under_data_vdevs(driver):
    ...
    time.sleep(2)
    assert wait_on_element(driver, 7, '//mat-checkbox[@id="pool-manager__disks-sdd"]', 'clickable')
    driver.find_element_by_xpath('//mat-checkbox[@id="pool-manager__disks-sdd"]').click()
    time.sleep(2)
