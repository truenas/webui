...
def the_user_field_should_expand_down_click_the_edit_button(driver):
    ...
    assert wait_on_element(driver, 10, '//tr[contains(.,"root")][1]/following-sibling::tr)[1]//button[contains(.,"Edit")]', 'clickable')
    driver.find_element_by_xpath('//tr[contains(.,"root")][1]/following-sibling::tr)[1]//button[contains(.,"Edit")]').click()
