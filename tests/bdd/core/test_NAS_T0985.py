...
def when_the_pool_manager_appears_enter_the_tank_for_pool_name(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//div[contains(.,"Pool Manager")]')
...
def the_tank_should_appear_in_the_list(driver):
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-panel-title[contains(.,"tank")]')
    assert wait_on_element(driver, 0.5, 7, '//td[@ix-auto="value__tank_name"]')
