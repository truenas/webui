...
def select_create_new_pool_and_click_create_pool(driver):
    ...
    assert wait_on_element(driver, 0.5, 7, '//button[@ix-auto="button__CREATE POOL"]')
...
def the_create_pool_widget_should_appear_while_the_pool_is_being_created(driver):
    ...
    assert wait_on_element_disappear(driver, 1, 20, '//h1[contains(.,"Create Pool")]')
...
def click_systems_on_the_side_menu_and_click_system_dataset(driver):
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-list-item[@ix-auto="option__System Dataset"]')
...
def when_the_system_dataset_page_appears_click_on_system_dataset_pool(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//h4[contains(.,"Configure System Dataset")]')
    assert wait_on_element(driver, 1, 7, '//mat-select[@ix-auto="select__System Dataset Pool"]')
...
def select_system_and_click_save(driver):
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-option[@ix-auto="option__System Dataset Pool_system"]')
