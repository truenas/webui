...
def click_on_directory_services_on_the_side_menu_and_click_ldap(driver):
    ...
    assert wait_on_element(driver, 1, 5, '//mat-list-item[@ix-auto="option__Directory Services"]')
...
def click_enable_checkbox_then_samba_schema_and_select_on_for_encryption_mode(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//mat-select[@ix-auto="select__Encryption Mode"]')
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-option[@ix-auto="option__Encryption Mode_ON"]')
