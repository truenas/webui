...
def click_on_storage_on_the_side_menu_click_on_pools(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//div[contains(.,"Pools")]')
...
def the_dataset_should_be_created_without_error(driver):
    ...
    assert wait_on_element(driver, 0.5, 10, '//span[contains(.,"guest")]')
...
def click_advanced_options_and_check_the_allow_guest_access_box(driver):
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-checkbox[@ix-auto="checkbox__Allow Guest Access"]')
...
def click_submit_the_new_share_should_be_created_without_error(driver):
    ...
    driver.find_element_by_xpath('//button[@ix-auto="button__SUBMIT"]').click()
    assert wait_on_element_disappear(driver, 1, 20, '//h6[contains(.,"Please wait")]')
    assert wait_on_element(driver, 0.5, 7, '//div[contains(.,"guest_share")]')
...
def click_on_the_guest_dataset_3_dots_button_select_edit_permissions(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//mat-icon[@id="actions_menu_button__guest"]')
    driver.find_element_by_xpath('//mat-icon[@id="actions_menu_button__guest"]').click()
    assert wait_on_element(driver, 1, 7, '//button[@ix-auto="action__guest_Edit Permissions"]')
...
def on_the_edit_acl_page_set_the_user_to_nobody_and_the_group_to_nogroup(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//h4[contains(.,"File Information")]')
    driver.find_element_by_xpath('//button[@ix-auto="button__SELECT AN ACL PRESET"]').click()
    assert wait_on_element(driver, 1, 7, '//mat-select[@ix-auto="select__Default ACL Options"]')
    driver.find_element_by_xpath('//mat-select[@ix-auto="select__Default ACL Options"]').click()
    assert wait_on_element(driver, 0.5, 7, '//mat-option[@ix-auto="option__Default ACL Options_OPEN"]')
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-option[@ix-auto="option__nobody"]')
    ...
    assert wait_on_element(driver, 0.5, 7, '//mat-option[@ix-auto="option__nogroup"]')
    ActionChains(driver).send_keys(Keys.ESCAPE).perform()
