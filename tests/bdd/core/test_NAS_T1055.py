...
@then('umount the mountpoint and delete the mountpoint direc')
def umount_the_mountpoint_and_delete_the_mountpoint_direc(driver):
    """umount the mountpoint and delete the mountpoint direc."""
