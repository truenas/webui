...
@scenario('features/NAS-T1007.feature', 'Create a smb share with the tank ACL dataset')
def test_create_a_smb_share_with_the_tank_acl_dataset(driver):
    """Create a smb share with the tank ACL dataset."""
