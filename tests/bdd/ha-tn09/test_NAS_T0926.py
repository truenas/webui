...
@then(parsers.parse('Wait for second node "{serial}" to be up'))
def wait_for_second_node_to_be_up(driver, serial):
    """Wait for second node "{serial}" to be up"""
    assert wait_on_element(driver, 1, 60, f'//span[contains(.,"{serial}")]')
