...
def click_on_the_dozer_3_dots_button_select_add_dataset(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//mat-icon[@id="actions_menu_button__dozer"]')
    driver.find_element_by_xpath('//mat-icon[@id="actions_menu_button__dozer"]').click()
    assert wait_on_element(driver, 1, 7, '//button[@ix-auto="action__dozer_Add Dataset"]')
...
def click_the_save_button_should_be_return_to_pool_page(driver):
    ...
    assert wait_on_element(driver, 1, 7, '//mat-panel-title[contains(.,"dozer")]')
