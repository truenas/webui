...
def uncheck_dhcp_check_critical_select_1_for_failover_group_input_ip_address_this_controller__then_select_23_ip_address_truenas_controller_2_virtual_ip_address(driver, ip1, netmask, ip2, vip):
    ...
    assert wait_on_element(driver, 5, xpaths.interface.add_Allias, 'clickable')
    ...
    driver.find_element_by_xpath(xpaths.interface.ip_Address_Input).send_keys(ip1)
    ...
    driver.find_element_by_xpath(xpaths.interface.failover_Address_Input).send_keys(ip2)
    driver.find_element_by_xpath(xpaths.interface.failover_Virtual_Address).clear()
    driver.find_element_by_xpath(xpaths.interface.failover_Virtual_Address).send_keys(vip)
