...
def test_01_nav_guide(wb_driver):
    # Click an element indirectly
    wb_driver.find_element_by_xpath(xpaths['navGuide']).click()
...
def test_02_check_version(wb_driver):
    # cancelling the tour
    if is_element_present(wb_driver, '/html/body/div[6]/div[1]/button'):
