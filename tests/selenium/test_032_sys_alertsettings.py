...
xpaths = {
    ...
    'submenuAlertsettings': "//a[contains(text(),'Alert Settings')]",
...
def test_01_nav_system_alertsettings(wb_driver):
    wb_driver.find_element_by_xpath(xpaths['submenuAlertsettings']).click()
    # get the ui element
