...
xpaths = {
    ...
    'buttonChecknow': "/html/body/ix-root/app-admin-layout/mat-sidenav-container/mat-sidenav-content/div/app-update/mat-card/div/div[3]/div/button[1]",
...
def test_02_check_update_now(browser):
    ...
    if is_element_present(browser, "/html/body/ix-root/app-admin-layout/mat-sidenav-container/mat-sidenav-content/div/app-update/mat-card[1]/div/div[4]/div/table/tbody/tr[1]/td[1]"):
        ui_element = browser.find_element_by_xpath("/html/body/ix-root/app-admin-layout/mat-sidenav-container/mat-sidenav-content/div/app-update/mat-card[1]/div/div[4]/div/table/tbody/tr[1]/td[1]")
        ...
        if update_data == "Upgrade":
            ...
            error_check_sys()
    elif is_element_present(browser, "/html/body/ix-root/app-admin-layout/md-sidenav-container/div[6]/div/app-update/md-card/div/div[4]/div/div"):
        ui_element2 = browser.find_element_by_xpath("/html/body/ix-root/app-admin-layout/md-sidenav-container/div[6]/div/app-update/md-card/div/div[4]/div/div")
